...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (selectedBrand) {
        // Assuming you have a function `filterProductsByBrand` that filters and displays products
        filterProductsByBrand(selectedBrand);
    }
});

function filterProductsByBrand(brand) {
    const allProducts = document.querySelectorAll('.product-card'); // Adjust the selector based on your HTML structure
    allProducts.forEach(product => {
        const productBrand = product.getAttribute('data-brand'); // Assuming each product card has a data-brand attribute
